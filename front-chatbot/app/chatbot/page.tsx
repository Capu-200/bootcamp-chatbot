            ...
            <div className="relative isolate pt-14 lg:px-8 flex flex-row justify-center pb-20 h-dvh bg-white">
                <div className="flex flex-col justify-between gap-4">
                    ...
                    <div className="flex flex-col items-start gap-4 w-full justify-center">
                        ...
                        {/* <button id="" className="text-gray-800 text-xs font-medium py-1 px-2 rounded-full bg-red-200 hover:bg-red-300"> Thriller </button>
                        <button id="" className="text-gray-800 text-xs font-medium py-1 px-2 rounded-full bg-blue-200 hover:bg-blue-300"> Thriller </button>
                        <button className="text-gray-800 text-xs font-medium py-1 px-2 rounded-full bg-blue-200 hover:bg-blue-300"> Thriller </button>
                        <button className="text-gray-800 text-xs font-medium py-1 px-2 rounded-full bg-blue-200 hover:bg-blue-300"> Thriller </button> */}
                    </div>
                </div>
            </div>
